                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5 px-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('tanggal_publish') is-invalid @enderror" name="tanggal_publish" id="tanggal_publish" value="{{ old('tanggal_publish') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="string" class="form-control @error('tag') is-invalid @enderror" name="tag" id="tag" value="{{ old('tag') }}">
                                    @error('tag')
                                        <div class="text-danger small mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
