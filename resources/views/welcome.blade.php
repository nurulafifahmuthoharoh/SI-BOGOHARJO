...
<section class="banner-area relative">
  ...
  <div class="container">
    <div class="row fullscreen align-items-center justify-content-between">
      <div class="col-lg-6 col-md-6 banner-left pt-80">
        <h6 class="text-white">SISTEM INFORMASI PENGELOLAAN UNIT USAHA</h6>
        <h1 class="text-white">BUMDES BOGOHARJO</h1>
        <p class="text-white">Sistem informasi ini menyediakan informasi terkait unit usaha yang dikelola oleh BUMDes Bogoharjo. Sistem informasi ini sebagai pusat informasi dan pelayanan bagi masyarakat, kami hadir untuk memberikan akses yang mudah dan transparan terhadap layanan-layanan BUMDes.</p>
        <div class="input-group mb-2" style="border-radius: 50%; max-width: 400px;">
          <input id="search-input" type="text" class="form-control" placeholder="pencarian untuk unit usaha........" aria-label="Search Product" aria-describedby="button-addon2">
...
<!-- Start Unit Usaha -->
<section id="unitusaha" class="section-gap">
  <div class="container">
    <div class="row justify-content-center">
      <div class="menu-content pb-70 col-lg-8">
        <div class="title text-center">
          <h1 class="mb-10">Unit Usaha</h1>
          <p class="text-center">Tersedia beragam unit usaha yang bertujuan untuk memenuhi berbagai kebutuhan masyarakat</p>
        </div>
      </div>
      <div class="card" style="background-color: #16A75C; color: white;">
        <div class="card-body">
          <div class="row">
            <div class="col-lg-4 col-md-4 mb-3">
              <div class="row align-items-center">
                <div class="col-auto">
                  <a href="{{ route('lumbungpadi') }}">
                    <img src="img/gambar/padi.png" alt="Padi" class="img-fluid">
                  </a>
                </div>
                <div class="col">
                  <h4 class="card-title mb-2 text-white">
                    <a href="{{ route('lumbungpadi') }}" class="text-white">Lumbung Padi</a>
                  </h4>
                  <p class="card-text">Unit usaha Lumbung Padi kami memberikan solusi unik bagi para petani lokal. Kami menawarkan peminjaman padi sebelum panen, yang memungkinkan petani untuk mengakses padi sebelum masa panen mereka tiba.</p>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-4 mb-3">
              <div class="row align-items-center">
                <div class="col-auto">
                  <a href="{{ route('sewatratak') }}">
                    <img src="img/gambar/tenda.png" alt="Tenda" class="img-fluid">
                  </a>
                </div>
                <div class="col">
                  <h4 class="card-title mb-2 text-white">
                    <a href="{{ route('sewatratak') }}" class="text-white">Sewa Tratak</a>
                  </h4>
                  <p class="card-text">Unit usaha Persewaan Tratak kami menyediakan solusi lengkap untuk kebutuhan acara Anda. Kami menyediakan berbagai macam tenda berkualitas tinggi untuk memenuhi segala jenis acara dan ukuran tempat.</p>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-0 mb-0">
              <div class="row align-items-center">
                <div class="col-auto">
                  <a href="{{ route('airbersih') }}">
                    <img src="img/gambar/air.png" alt="Air" class="img-fluid" style="padding-top: 10px;"> <!-- Tambahkan padding-top di sini -->
                  </a>
                </div>
                <div class="col">
                  <h4 class="card-title mb-2 text-white">
                    <a href="{{ route('airbersih') }}" class="text-white">Air Bersih</a>
                  </h4>
                  <p class="card-text">Unit Usaha Air Bersih BUMDes Bogoharjo menyediakan akses mudah dan aman kepada masyarakat Desa Bogoharjo untuk mendapatkan air bersih yang berkualitas dan terjamin mutu.</p>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="row d-flex justify-content-center">
      <div class="menu-content pb-10 col-lg-8">
        <div class="title text-center">
          ...
          <p align="Center">"Berita Terkini dan Berguna untuk Anda: Temukan Segala Hal tentang BUMDes Bogoharjo"</p>
        </div>
      </div>
