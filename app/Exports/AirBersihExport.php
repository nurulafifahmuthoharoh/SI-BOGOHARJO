...
class AirBersihExport implements FromView, WithEvents, ShouldAutoSize
{
    use Exportable;
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class    => function(AfterSheet $event) {
                ...
                $event->sheet->getStyle('A5:I5')->applyFromArray($styleArray);
    ...
    public function view(): View
    {
        ...
        return view('admin.airbersih.report.export', [
            'airbersih' => $airbersih,
